...
# Thiết lập Từ điển Song ngữ Trung - Việt (Không chứa từ "AI")
LANG = {
    "vi": {
...
# Kích hoạt kết nối Gemini API thông qua Streamlit Secrets
GEMINI_KEY = st.secrets.get("GEMINI_API_KEY", None)

# ==========================================
# 2. HÀM TRỢ GIÚP ĐỒNG NHẤT CỘT
# ==========================================
def ask_gemini_for_headers(columns_list, file_type_desc):
    """
    Sử dụng hệ thống phân tích để phân tích danh sách tiêu đề thực tế từ file excel 
    và ánh xạ về các từ khóa chuẩn hóa.
    """
    if not GEMINI_KEY:
        return None
    try:
...
def fallback_header_match(columns_list):
    """
    Hàm Python tự động quét tiêu đề dự phòng nếu hệ thống phân tích không phản hồi.
    """
